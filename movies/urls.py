...
urlpatterns = [
    ...
    path('payment/<int:booking_id>/checkout/', views.create_stripe_checkout_session, name='create_stripe_checkout_session'),
    path('payment/success/<int:booking_id>/', views.payment_success, name='payment_success'),
    path('payment/cancel/<int:booking_id>/', views.payment_cancel, name='payment_cancel'),
    path('payment/sandbox/<int:booking_id>/', views.payment_sandbox, name='payment_sandbox'),
    path('payment/sandbox-process/<int:booking_id>/', views.sandbox_process_payment, name='sandbox_process_payment'),
